...
public class ThreeSpecimenAutoV2 extends LinearOpMode {
    ...
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.MM, -530, 0, AngleUnit.DEGREES, 0);
    ...
    static final Pose2D TARGET_7 = new Pose2D(DistanceUnit.MM, -192, 780, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_8 = new Pose2D(DistanceUnit.MM, -200, -200, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_9 = new Pose2D(DistanceUnit.MM, -530, -200, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_10 = new Pose2D(DistanceUnit.MM, -192, 780, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_11 = new Pose2D(DistanceUnit.MM, -200, -400, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_12 = new Pose2D(DistanceUnit.MM, -530, -400, AngleUnit.DEGREES, 0);
...
//                        transfer();
                ...
                case DRIVE_TO_TARGET_7:
                    if(nav.driveTo(odo.getPosition(), TARGET_7, .7, .5)){
...
//                        transfer();
    ...
    public void transfer(){
        leftgrab.setPosition(.31);
        rightgrab.setPosition(.67);
        sleep(200);
        grab.setPosition(1);
    }
    ...
    public void back_arm_bar(){
        arm1.setPosition(0.36);
        arm2.setPosition(0.64);
    }
    ...
    public void highRung() {
        cap.setPower(1);
        cap2.setPower(1);
        cap.setTargetPosition(-500);
        cap2.setTargetPosition(-500);
        cap.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        cap2.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    }
