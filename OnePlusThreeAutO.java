...
@Autonomous(name="1+3Auto", group="Auto")
//@Disabled
...
public class OnePlusThreeAutO extends LinearOpMode {
    ...
    enum StateMachine {
        ...
        DRIVE_TO_TARGET_19,
        DRIVE_TO_TARGET_20,
        DRIVE_TO_TARGET_2AND1HALF,
        DRIVE_TO_TARGET_2AND3QUARTERS
    }
    ...
    static final Pose2D TARGET_2AND1HALF = new Pose2D(DistanceUnit.MM, -300, 0, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_2AND3QUARTERS = new Pose2D(DistanceUnit.MM, -300, 200, AngleUnit.DEGREES, 170);

    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.MM,-550,-1010, AngleUnit.DEGREES,170);
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM, -400, -600, AngleUnit.DEGREES, 135);
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.MM, -180, -820, AngleUnit.DEGREES, 135);
    static final Pose2D TARGET_6 = new Pose2D(DistanceUnit.MM, -200,-700, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_7 = new Pose2D(DistanceUnit.MM, -550, -1150, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_8 = new Pose2D(DistanceUnit.MM, -400, -800, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_9 = new Pose2D(DistanceUnit.MM, -200, -1000, AngleUnit.DEGREES, 135);
    static final Pose2D TARGET_10 = new Pose2D(DistanceUnit.MM, -200, 1200, AngleUnit.DEGREES, 0);
    ...
    static final Pose2D TARGET_13 = new Pose2D(DistanceUnit.MM, -200, 1060, AngleUnit.DEGREES, 0);
...
//                        sleep(300);
                        ...
                        stateMachine = StateMachine.DRIVE_TO_TARGET_2AND1HALF;
                    }
                    break;
                case DRIVE_TO_TARGET_2AND1HALF:
                    //drive to the second target
                    if (nav.driveTo(odo.getPosition(), TARGET_2AND1HALF, 1, 1)){
                        telemetry.addLine("at position #2!");
                        stateMachine = StateMachine.DRIVE_TO_TARGET_2AND3QUARTERS;
                    }
                    break;
                case DRIVE_TO_TARGET_2AND3QUARTERS:
                    //drive to the second target
                    if (nav.driveTo(odo.getPosition(), TARGET_2AND3QUARTERS, 1, 1)){
                        telemetry.addLine("at position #2!");
                        stateMachine = StateMachine.DRIVE_TO_TARGET_3;
                    }
                    break;
                case DRIVE_TO_TARGET_3:
                    if(nav.driveTo(odo.getPosition(), TARGET_3, 1, .5)){
...
//                        forward_arm_back();
                ...
                case DRIVE_TO_TARGET_7:
                    if(nav.driveTo(odo.getPosition(), TARGET_7, 1, .5)){
