...
@Autonomous(name="2SpecimenAuto" , group="Auto")
//@Disabled
...
public class TwoSpecimenAuto extends LinearOpMode {
    ...
    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.MM,-200,900, AngleUnit.DEGREES,0);
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM, -400, -200, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.MM, -445, -200, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_6 = new Pose2D(DistanceUnit.MM, -200, 900, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_7 = new Pose2D(DistanceUnit.MM, -400, 0, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_8 = new Pose2D(DistanceUnit.MM, -300, 0, AngleUnit.DEGREES, 0);
    static final Pose2D TARGET_9 = new Pose2D(DistanceUnit.MM, -250, 900, AngleUnit.DEGREES, 0);
        ...
        while (opModeIsActive()) {
            ...
            switch (stateMachine){
                ...
                case DRIVE_TO_TARGET_1:
                     ...
                     */
                    if (nav.driveTo(odo.getPosition(), TARGET_1, .6, 1)){
                        forward_arm_up();
                        sleep(1000);
                        forward_arm_back();
                        sleep(500);
...
//                        forward_arm_up();
                ...
                case DRIVE_TO_TARGET_6:
                    if(nav.driveTo(odo.getPosition(), TARGET_6, 1, 1)){
...
//                    if(nav.driveTo(odo.getPosition(), TARGET_7, 1, 1)){
...
//                    if(nav.driveTo(odo.getPosition(), TARGET_8, 1, 1)){
//                        bottom();
...
//                    if(nav.driveTo(odo.getPosition(), TARGET_9, 1, 1)){
//                        forward_arm_back();
...
//                    if(nav.driveTo(odo.getPosition(), TARGET_10, 1, 1)){
...
//                    if(nav.driveTo(odo.getPosition(), TARGET_11, 1, 1)){
//
